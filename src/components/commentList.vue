<template>
  <div ref="tmsgBox">
    ...
    <div class="tmsg-commentshow">
      <ul class="tmsg-commentlist" style="margin-left: 80px">
        <li
          class="tmsg-c-item"
        ...
        >
            ...
            <header>
              ...
              <div class="i-name">
                  ...
                  <a
                    href="###"
                    >{{
                      item.toCommentUserName ? item.toCommentUserName : "访客"
                    }}</a
                  >
                </div>
              <!-- <div class="i-class">
          ...
          <multistage :children="item.children" />
          <!-- ++++++++++++++++++++++++ -->
          <!-- <ul
              ...
              <header>
                ...
                <div class="i-name">
                  <a
                    ...
                    :style="{ pointerEvents: citem.url ? 'all' : 'none' }"
                    >{{ citem.author ? citem.author : "访客" }}</a
                  >
                  <span>回复</span>
                  <a
                    :href="item.url ? item.url : '###'"
                    :style="{ pointerEvents: item.url ? 'all' : 'none' }"
                    >{{
                      citem.toCommentUserName ? citem.toCommentUserName : "访客"
                    }}</a
                  >
                </div>
                <div class="i-time">
...
export default {
  ...
  methods: {
    ...
    respondMsg: function (rootId, toCommentId, toCommentUserId) {
      ...
      //   dom.appendChild(this.$refs.commentBox);
      //   // sendMsg();
      // } else {
      //   that
